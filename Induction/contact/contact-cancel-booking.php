...
<head>
  ...
  <title>How do I cancel a booking? | UHI Induction Services</title>
...
<body>
  ...
  <div class="features-boxed">
    <div class="container">
      <div class="container">
        <h2 class="text-center" style="color:rgb(0, 0, 0);font-size:56px;font-weight:bold;font-family:'Roboto Condensed', sans-serif;">Cancel a booking</h2>
