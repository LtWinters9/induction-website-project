function getArticle() {
	...
	if(disttobottom<=500){ // User has scrolled to bottom
            ...
            if(XHR.readyState==4) {
                ...
                if(XHR.status==200) { // Two stage status check for IE8 support
                    ...
                    if(parseInt(responsedata.mainblogid)!=0 && responsedata.mainblogid) {
                        ...
                        console.log(responsedata.mainblogid);
                        ...
                        if((responsedata.currentuser.userid==responsedata.userposter && responsedata.currentuser.userlevel>1)|| responsedata.currentuser.userlevel>2) {
