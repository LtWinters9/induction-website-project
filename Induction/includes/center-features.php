<div class="row justify-content-center features">
    ...
    <div class="col-sm-6 col-md-5 col-lg-4 item">
        <div data-aos="zoom-in-down" data-aos-duration="600" data-aos-delay="600" data-aos-once="true" class="box"><i class="material-icons icon" style="color:#7e3ca6;">contact_mail</i>
            ...
            <p class="description" style="font-family:'Roboto Condensed', sans-serif;font-size:16px;">In need of technical support? Need to cancel a booking you have made with us or just simply want to contact the UHI help desk. Please click below to get in touch with us.&nbsp;</p><a href="../info/help" class="learn-more" style="font-family:'Roboto Condensed', sans-serif;">Contact now »</a></div>
    </div>
    <div class="col-sm-6 col-md-5 col-lg-4 item">
