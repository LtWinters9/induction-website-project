      ...
      <div class="card-body">
        <div id="nav-tabContent" class="tab-content">
          ...
          <div id="item-1-4" class="tab-pane fade" role="tabpanel" aria-labelledby="item-1-4-tab">
            ...
            <p style="color:#000000;"><i class="ion-android-cloud"></i> <a href="https://drive.google.com/open?/uc?download&id=1WM4oRRc3caAv94R4-JkcYuY3GnNAJPhVCGzCACO9v-w">Cloud Computing (1MB)</a>
