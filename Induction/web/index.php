      ...
      <div class="carousel-inner" role="listbox">
        <div class="carousel-item active">
          <div class="jumbotron hero-nature carousel-hero" style="background-image:url(&quot;../assets/img/union.png&quot;);">
            ...
            <p><a class="btn btn-primary btn-lg hero-button" role="button" href="../info/about-us.php" style="color:#ffffff;background-color:##37434d;">About us</a></p>
          </div>
        </div>
        <div class="carousel-item">
          <div class="jumbotron hero-photography carousel-hero" style="background-image:url(&quot;../assets/img/banner2.png&quot;);">
            ...
            <p><a class="btn btn-primary btn-lg hero-button" role="button" href="../contact/contact-student-services.php" style="background-color:##37434d;">Contact Student Services</a></p>
          </div>
        </div>
        <div class="carousel-item">
          <div class="jumbotron hero-technology carousel-hero" style="background-image:url(&quot;../assets/img/banner.jpg&quot;);">
            ...
            <p><a class="btn btn-primary btn-lg hero-button" role="button" href="../info/tour-the-campus.php" style="background-color:##37434d;font-family:'Roboto Condensed', sans-serif;">Tour the campus </a></p>
          </div>
        </div>
      </div>
